    ...
    return (
        <div className="my-work w-full p-10">
            <div className="pt-16 pb-16 w-full ml-auto mr-auto pr-4 pl-4 max-w-6xl">
                ...
                I'm always interested in learning new stuff and dipe deeper into specific themes. That's also why I teached myself web development, so you can see this site. 
